...
export class UnidEjecComponent implements OnInit {
  ...
  listUnidEjec:any=[];
  ngOnInit(): void {
    //Llamamos al metodo de obtener unidad cuando cargue el componente
    this.getunid();

    //Llamamos a la unidad ejecutora
  }
...
//Eliminamos la unidad a travez del id
eliminarUnidad(id){
